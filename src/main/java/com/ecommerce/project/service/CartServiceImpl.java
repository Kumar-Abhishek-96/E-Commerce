...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        Cart cart = cartRepository.findById(cartId)
                .orElseThrow(()->new ResourceNotFoundException("Cart ","cattId",cartId));
        ...
        if(newQuantity < 0 ){
            throw new APIException("The resulting qunatity cannot be negative.");
        }
    ...
    @Override
    public void upadteProductsInCart(Long cartId, Long productId) {
        Cart cart = cartRepository.findById(cartId)
                .orElseThrow(()->new ResourceNotFoundException("Cart ","cattId",cartId));
